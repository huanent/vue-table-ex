(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["teble-ex"] = factory();
	else
		root["teble-ex"] = factory();
...
// CONCATENATED MODULE: ./src/components/tableEx/TdEx.vue?vue&type=template&id=82e2d91c&
...
/* harmony default export */ var TdExvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    keydown: function keydown(e) {
      ...
      if (!this.enable || !this.tableEx.enable || !this.trEx.valid && e.keyCode == 40) return;
...
//# sourceMappingURL=teble-ex.umd.js.map